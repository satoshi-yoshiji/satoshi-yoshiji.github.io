...
We have access to clinical, genetic, and omics data from various biobanks including 500,000 individuals in the [UK Biobank](https://www.ukbiobank.ac.uk/), 250,000 individuals in the [All of Us Research Program](https://allofus.nih.gov/) (a NIH-led multi-ancestry biobank), [Canadian Longitudinal Study on Aging](https://www.clsa-elcv.ca/), and the [Mass General Brigham Biobank](https://cgm.massgeneral.org/) (through collaboration with the [Broad Institute](https://www.broadinstitute.org/)).<br />

Additionally, we are contributing to international GWAS consortia including [Type 2 Diabetes Global Genomics Initiative](https://diagram-consortium.org/) (type 2 diabetes), [MAGIC](https://magicinvestigators.org/) (glycemic traits), [CARDIoGRAMplusC4D](http://www.cardiogramplusc4d.org/) (coronary artery disease), [GIANT](https://portals.broadinstitute.org/collaboration/giant/) (anthropometric traits), and GO3 (osteoarthritis).
...
Yoshiji, S., et al. Proteome-wide Mendelian randomization implicates nephronectin as an actionable mediator of the effect of obesity on COVID-19 severity. *Nat Metab* 5, 248–264 (2023). [doi.org/10.1038/s42255-023-00742-w](https://doi.org/10.1038/s42255-023-00742-w)  
Yoshiji, S., et al. COL6A3-derived endotrophin mediates the effect of obesity on coronary artery disease: an integrative proteogenomics analysis. *medRxiv* (2023). [doi.org/10.1101/2023.04.19.23288706](https://doi.org/10.1101/2023.04.19.23288706)  
Su, C-Y., et al. Multi-ancestry proteome-wide Mendelian randomization offers a comprehensive protein-disease atlas and potential therapeutic targets. *medRxiv* (2024). [doi.org/10.1101/2024.10.17.24315553](https://doi.org/10.1101/2024.10.17.24315553); [ASHG (2024)](https://www.ashg.org/) — Platform presentation
...
• We will generate the data on a rolling basis and are committed to open science through data sharing with the community.
...
In collaboration with the [Flannick lab](https://www.broadinstitute.org/flannick-lab) at the [Broad Institute of MIT and Harvard](https://www.broadinstitute.org/), we are using a new Bayesian method to characterize each subtype, identify causal genes, and understand their underlying biology.  
Further details were presented at [ASHG 2024](https://www.ashg.org/).
