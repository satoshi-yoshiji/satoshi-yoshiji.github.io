...
McGill University in Montreal, Canada, consistently ranks among the top 30 universities in the **QS World University Rankings 2025**. Montreal ranks **#1 among QS Best Student Cities in North America** and **#10 globally**.
...
Positions will be filled on a rolling basis, with the first deadline on **February 24, 2025**. We may close the call once positions are filled. Early submissions/inquiries are encouraged.

---

## Your Project

You will lead and publish projects aligned with the lab’s key research interests:

1. **Large-scale human genetics and multi-omics analysis for drug target discovery**:  
   We combine genomics, proteomics, and other omics with genetic epidemiology to understand cardiometabolic diseases and discover therapeutic targets.

2. **Building and analyzing a new biobank, BioPortal**:  
   We are creating a multi-ancestry, multi-omics biobank of 12,500 individuals (with an eventual goal of 100,000) in Montreal to advance drug development and precision medicine.

3. **Disentangling the heterogeneity of cardiometabolic diseases**:  
   Using genomics and proteomics, we dissect the genetic heterogeneity of diabetes and complex traits to identify distinct biological pathways, potential therapeutic targets, and opportunities for precision medicine.

---

## Your Key Roles

- Execute your project, write and publish manuscripts under the PI’s supervision  
- Collaborate with lab members, CERC members, and national/international collaborators  
- Keep up-to-date on relevant studies and methods, and actively discuss them with the PI and the team  
- Present your work at national and international conferences  
- Attend lab meetings, CERC seminars, journal clubs, and lab events; foster a welcoming and inclusive environment  
- Work with a goal-oriented mindset and respect deadlines in a fast-paced environment  
- Work in the lab on weekdays with a work-from-home option as needed (note that Monday is reserved for lab meetings and seminars). Flexible work arrangements are possible for classes, health, or severe weather
...
- **MSc/PhD positions**:  
  ...
  - **Winter 2026**: No restriction on status. We encourage all motivated candidates to apply.
...
- Bachelor’s or Master’s in a relevant field (e.g., genetics, biology, biology/life science-related specialties, medicine, bioinformatics, biostatistics, computer science or related area)  
...
- Experience in genetic epidemiology, bioinformatics, biostatistics  
- Experience with high-performance computing (e.g., institutional HPC, Digital Research Alliance of Canada, Google Cloud)
...
**February 24, 2025**  
We may close applications once positions are filled, so early submissions/inquiries are encouraged.
...
Source: [https://www.numbeo.com/cost-of-living/comparison.jsp](https://www.numbeo.com/cost-of-living/comparison.jsp) *(as of Jan 25, 2025)*
